...
router.route("/:id").get(verifyToken, verifyRoles("contractor"), getUserByID).patch(verifyToken, verifyRoles("admin"), updateUser).delete(verifyToken, verifyRoles("admin"), deleteUser);
